...
namespace LinqToStdf.Records.V4 {
    ...
    StdfStringLayout(FieldIndex = 9, AssignTo = "TestText", MissingValue = ""),
    StdfStringLayout(FieldIndex = 10, AssignTo = "AlarmId", MissingValue = ""),
    ...
    StdfStringLayout(FieldIndex = 20, AssignTo = "Units", MissingValue = ""),
    StdfStringLayout(FieldIndex = 21, AssignTo = "IncrementUnits", MissingValue = ""),
    StdfStringLayout(FieldIndex = 22, AssignTo = "ResultFormatString", MissingValue = ""),
    StdfStringLayout(FieldIndex = 23, AssignTo = "LowLimitFormatString", MissingValue = ""),
    StdfStringLayout(FieldIndex = 24, AssignTo = "HighLimitFormatString", MissingValue = ""),
