...
namespace LinqToStdf.Records.V4 {
    ...
    StdfStringLayout(FieldIndex = 6, AssignTo = "TestText"),
    StdfStringLayout(FieldIndex = 7, AssignTo = "AlarmId"),
    ...
    StdfStringLayout(FieldIndex = 14, AssignTo = "Units"),
    StdfStringLayout(FieldIndex = 15, AssignTo = "ResultFormatString"),
    StdfStringLayout(FieldIndex = 16, AssignTo = "LowLimitFormatString"),
    StdfStringLayout(FieldIndex = 17, AssignTo = "HighLimitFormatString"),
